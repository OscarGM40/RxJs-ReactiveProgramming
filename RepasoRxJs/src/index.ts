...
progressBar.style.top = (0).toString();
progressBar.style.left = (0).toString();
progressBar.style.backgroundColor = "#9034AA";
progressBar.style.borderTopRightRadius = ".3rem";
progressBar.style.borderBottomRightRadius = ".6rem";

const calculateScrollPercent = (event) => {
  /* recuerda usar destructuración a ser posible */
...
document.body.append(text, progressBar);
